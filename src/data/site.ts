...
export const copy = {
  ...
  'zh-tw': {
    ...
    features:[['原汁原味的規則，一段完整故事','保留熟悉的大老二玩法，以劇情推動整段旅程——沒有 roguelike，也不用組牌。'],['獨特對手','每名對手都有自己的個性、房間、音樂與對話。'],['技能卡','偷看、交換、強制 PASS；一次性技能卡能讓敗局出現轉機。'],['多重結局','等待玩家親自發掘的多重結局。'],['收藏藝廊','解鎖並重溫角色立繪、CG 與音樂。'],['隨時存檔','五個手動存檔欄位，加上自動存檔。'],['照你的方式玩','完整支援鍵盤與滑鼠。'],['三種語言','支援英文、繁體中文與日文。']],
    ...
    short:'DULAN 是一款劇情式大老二遊戲。負債累累的你踏入地下賭場，迎戰個性、房間、音樂與對話都截然不同的對手。遊戲不以 roguelike 或牌組構築重新發明大老二，而是完整保留原版規則，讓一場完整的敘事冒險在牌桌上展開。一次性技能卡能讓敗局出現轉機，而你的打法也將帶你走向不同結局。本作由台灣獨立開發者一人製作，支援英文、繁體中文與日文。',
  ...
  ja: {
    ...
    storySeo:'秘密を抱えた地下カジノを舞台に、おなじみの大富豪で物語を紡ぐストーリー重視のカードゲーム「DULAN」。',
    story:['あなたの名は「不運のウー」。借金、失業、借金取りに追われ、コンビニのおでんすら一本多く取れない。追い詰められたあなたは、伝説の地下カジノ「賭爛」へ辿り着く。勝利するたび、生き延びる望みがつながる。敗北するたび、カジノの深みへと沈んでいく。','DULANは、おなじみの大富豪のルールをそのままに、カードテーブルを中心とした冒険を描くストーリー重視のカードゲーム。立ちはだかる相手を倒し、人生を逆転するためにすべてを賭けろ。だが、あなたはまだ知らない……このカジノに隠された秘密を……。'],
    ...
    features:[['そのままのルールで、ひとつの物語を','おなじみの大富豪を物語仕立てで楽しむ。ローグライクでも、デッキ構築でもない。'],['個性的な対戦相手','性格も、部屋も、音楽も、会話も、それぞれ違う。'],['スキルカード','覗き見、交換、強制パス。使い切りの一枚が劣勢を覆す。'],['複数のエンディング','その先に待つ結末は、ひとつではない。'],['アンロックギャラリー','キャラクター、CG、音楽を解放して鑑賞。'],['セーブ機能','手動セーブ5枠とオートセーブに対応。'],['好きな操作で','キーボードとマウスに完全対応。'],['三言語対応','英語、繁体字中国語、日本語。']],
    ...
    short:'DULANは、物語仕立ての大富豪ゲーム。借金まみれのあなたは地下カジノへ足を踏み入れ、性格も、部屋も、音楽も、会話も異なる相手と勝負する。ローグライクやデッキ構築に作り変えることなく、おなじみのルールをそのままに、一篇の物語を卓上で描く。使い切りのスキルカードが劣勢を覆し、プレイの仕方が異なる結末へ導いていく。台湾の個人開発者が一人で制作。英語、繁体字中国語、日本語に対応。',
