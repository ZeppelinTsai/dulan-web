...
export const copy = {
  en: {
    ...
    story:[
      ...
      'Defeat the Four Kings, and you may challenge the true ruler and turn your life around. But there is something you do not know… This casino is hiding a secret…'
    ],
    storyKicker:'Four Kings stand between you and a chance to turn your life around.',
  ...
  'zh-tw': {
    ...
    story:['你叫伍告雖（有夠衰）。負債、失業、被討債，連便利商店的關東煮都不敢多夾一根。走投無路的你，來到傳說中的地下賭場「賭爛」。','只要打倒四大天王，就能挑戰真正的支配者，翻轉人生。但你不知道的是……這間賭場，隱藏了秘密……。'],
    storyKicker:'打倒四大天王，挑戰真正的支配者，翻轉人生。', featureShort:['劇情式大老二','五名令人難忘的對手','等待發掘的多重結局','一次性技能卡'],
    features:[['原汁原味的規則，一段完整故事','保留熟悉的大老二玩法，以劇情推動整段旅程——沒有 roguelike，也不用組牌。'],['五名獨特對手','每名對手都有自己的個性、房間、音樂與對話。'],['技能卡','偷看、交換、強制 PASS；一次性技能卡能讓敗局出現轉機。'],['多重結局','等待玩家親自發掘的多重結局。'],['收藏藝廊','解鎖並重溫角色立繪、CG 與音樂。'],['隨時存檔','五個手動存檔欄位，加上自動存檔。'],['照你的方式玩','完整支援鍵盤、滑鼠與控制器。'],['三種語言','支援英文、繁體中文與日文。']],
    characters:'各路牌客，各有不能攤在桌面上的理由。', downloadIntro:'Windows 版登上 DULAN。首發優惠 US$2.99，原價 US$3.99。',
  ...
  ja: {
    ...
    story:['あなたの名は「不運のウー」。借金、失業、借金取りに追われ、コンビニのおでんすら一本多く取れない。追い詰められたあなたは、伝説の地下カジノ「賭爛」へ辿り着く。','四天王を倒せば、真の支配者に挑み、人生を逆転できる。だが、あなたはまだ知らない……このカジノに隠された秘密を……。'],
    storyKicker:'四天王を倒し、真の支配者に挑み、人生を逆転しろ。',featureShort:['物語で進む大富豪','忘れられない五人の対戦相手','自分で見つける複数の結末','使い切りのスキルカード'],
    features:[['そのままのルールで、ひとつの物語を','おなじみの大富豪を物語仕立てで楽しむ。ローグライクでも、デッキ構築でもない。'],['五人の個性的な対戦相手','性格も、部屋も、音楽も、会話も、それぞれ違う。'],['スキルカード','覗き見、交換、強制パス。使い切りの一枚が劣勢を覆す。'],['複数のエンディング','その先に待つ結末は、ひとつではない。'],['アンロックギャラリー','キャラクター、CG、音楽を解放して鑑賞。'],['セーブ機能','手動セーブ5枠とオートセーブに対応。'],['好きな操作で','キーボード、マウス、コントローラーに完全対応。'],['三言語対応','英語、繁体字中国語、日本語。']],
    characters:'さまざまな勝負師。それぞれに、卓上では明かせない理由がある。',downloadIntro:'Windows版 DULAN。発売記念価格 US$2.99、通常価格 US$3.99。',
